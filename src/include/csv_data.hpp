...
struct csv_data {
  ...
  float extras_dedx_pip;
  float extras_dedx_pim;
  float extras_dedx_prot;  //////////
  ...
  static std::string header() {
    ...
    // return
    // "pid_part,beta_part,mom_part,charge_part,cnd_comp,cnd_energy,cnd_path,cnd_time,cnd_pindex,cnd_layer,ctof_comp,extras_dedx,extras_size,extras_layermult";
    ...
    // return
    // "prot_mom_gen,prot_theta_gen,prot_phi_gen,pip_mom_gen,pip_theta_gen,pip_phi_gen,pim_mom_gen,pim_theta_gen,"
