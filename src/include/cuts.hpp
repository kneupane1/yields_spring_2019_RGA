...
class Pid_Cuts : public Cuts {
 public:
  Pid_Cuts(const std::shared_ptr<Branches12>& data) : Cuts(data) {}
  Pid_Cuts(const std::shared_ptr<Branches12>& data, const std::shared_ptr<Delta_T>& dt) : Cuts(data, dt) {};
  bool ElectronCuts();
